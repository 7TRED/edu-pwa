    ...
    return (
        <div className="chat-input-container container flex flex-col shadow-md mt-8 mb-4">
            <div className = "chat-input container m-1 flex-start">
                ...
                <button onClick={(e)=>handleSubmit()}><BsFillSendFill className="h-full w-full rotate-45" color="#ba4bff" /></button>
            </div>
            {showFilePreview && (<div className="chat-options flex items-end justify-end p-2 w-full">
                {showFilePreview && <UploadPreview fileObjectURL={URL.createObjectURL(file)} filename={fileName} onCancel={handleFileUploadCancel} />}
